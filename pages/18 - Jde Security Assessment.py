...
# Page configuration
st.set_page_config(
    page_title="JD Edwards Security Assessment · i on GRC",
...
def main():
    ...
    portfolio_skin.page_header(
        title="JD Edwards Security Assessment",
    ...
    with st.sidebar:
        ...
        st.session_state.jde_score_adjust = st.slider(
            "What-if compliance adjust",
            -20,
            20,
            int(st.session_state.get("jde_score_adjust", 0)),
        )
...
def show_dashboard():
    ...
    adjust = int(st.session_state.get("jde_score_adjust", 0))
