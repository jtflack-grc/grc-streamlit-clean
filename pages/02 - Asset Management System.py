...
def generate_sample_data(seed: int = 42):
    ...
    assets = [
        ...
        # Brownfield / legacy platforms (additive)
        {
            'id': 'AST-2024-101',
            'name': 'IBM Power10 — Production IBM i LPAR',
            'category_id': 'CAT-003',
            'location_id': 'LOC-002',
            'asset_tag': 'IBMI-PRD-01',
            'serial_number': 'PWR10-77821',
            'model': 'Power S1022 / IBM i 7.5',
            'manufacturer': 'IBM',
            'purchase_date': datetime.datetime.now() - timedelta(days=900),
            'warranty_expiry': datetime.datetime.now() + timedelta(days=400),
            ...
            'department': 'IT',
            'criticality': 'Critical',
            'last_updated': datetime.datetime.now() - timedelta(days=3)
        },
        {
            'id': 'AST-2024-102',
            'name': 'IBM z16 — Production CPC',
            'category_id': 'CAT-003',
            'location_id': 'LOC-002',
            'asset_tag': 'ZOS-PRD-01',
            'serial_number': 'Z16-44012',
            'model': 'z16 / z/OS 3.1',
            'manufacturer': 'IBM',
            'purchase_date': datetime.datetime.now() - timedelta(days=600),
            'warranty_expiry': datetime.datetime.now() + timedelta(days=800),
            'purchase_cost': 2500000.00,
            'current_value': 1800000.00,
            'status': 'In Use',
            'assigned_to': 'Mainframe Ops',
            'department': 'IT',
            'criticality': 'Critical',
            'last_updated': datetime.datetime.now() - timedelta(days=1)
        },
        {
            'id': 'AST-2024-103',
            'name': 'AIX LPAR — ERP batch',
            'category_id': 'CAT-003',
            'location_id': 'LOC-002',
            'asset_tag': 'AIX-ERP-02',
            'serial_number': 'AIX-55209',
            'model': 'Power9 / AIX 7.3',
            'manufacturer': 'IBM',
            'purchase_date': datetime.datetime.now() - timedelta(days=1100),
            'warranty_expiry': datetime.datetime.now() + timedelta(days=200),
            'purchase_cost': 95000.00,
            'current_value': 40000.00,
            'status': 'In Use',
            'assigned_to': 'Unix Team',
            'department': 'IT',
            'criticality': 'High',
        ...
        },
        {
            ...
            'category_id': 'CAT-006',
            'location_id': 'LOC-002',
            'asset_tag': 'JDE-WORLD-01',
            'serial_number': 'JDE-W-FIN',
            'model': 'JD Edwards World A9.4',
            'manufacturer': 'Oracle',
            'purchase_date': datetime.datetime.now() - timedelta(days=2200),
            'warranty_expiry': datetime.datetime.now() + timedelta(days=120),
            'purchase_cost': 450000.00,
            'current_value': 90000.00,
            'status': 'In Use',
            'assigned_to': 'ERP Team',
            'department': 'Finance',
            'criticality': 'Critical',
            'last_updated': datetime.datetime.now() - timedelta(days=4)
        },
    ]
